...
function Contact() {
    ...
    return (
        <div className="bg-white">
            <div className="max-w-7xl md:pt-10 m-auto px-4 md:px-8 py-16">
                <div className="grid md:grid-cols-2 md:gap-8">
                    <div className="">
                        ...
                        <p className="text-sm md:text-base text-[color:var(--secondary-color)]">
                            Our team is here to help you. If you have any
                    ...
                    <div className="flex gap-4 mt-8 w-full">
                        <div className="w-full divide-y">
                            ...
                            <div className="py-3">
                                ...
                                <p className="font-medium">
                                    Direct Jobs, Near Metro Station, Lajpath
                                    Nagar, Delhi, India - 110024
                                </p>
                                <p className="text">
                                    <span className="font-medium">Email:</span>{" "}
                                    <a
                ...
                <div className="mt-8 md:mt-16 text-center">
                    <p>
                        ...
                        to get instant resolution to your queries. If you still
