...
function PopupModal({ children, closePopup }) {
    return (
        <div className="fixed w-full h-screen overflow-hidden bg-black bg-opacity-70 left-0 top-0 z-50">
            <div className="h-dvh">
                <div
                ...
                <div className="h-[85%] w-full flex items-end justify-end">
                    <div className="w-full h-full bg-white p-5 rounded-t-md">{children}</div>
                </div>
            </div>
        </div>
    );
