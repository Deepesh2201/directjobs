...
function HeroSection() {
    return (
        <div className="grid md:grid-cols-2 relative lg:gap-2 lg:px-2 max-w-7xl m-auto lg:mt-8">
            <div
            ...
            <div
                style={{ backgroundImage: `url(${background})` }}
                className="bg-[#ffd302] bg-cover bg-center bg-no-repeat flex items-center justify-around px-5 lg:px-10 text-black lg:rounded-md"
            >
