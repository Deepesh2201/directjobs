...
import abstract from "../../assets/abstracts/abstract_3.png";

function Footer() {
    const [exploreLinksCount] = useState(24);
    ...
    return (
        <>
            ...
            <section className="relative overflow-hidden text-white bg-gradient-secondary">
                <div className="bg-bottom lg:bg-left bg-repeat-x bg-contain divide-gray-500 divide-y" style={{ backgroundImage: `url(${abstract})` }}>
